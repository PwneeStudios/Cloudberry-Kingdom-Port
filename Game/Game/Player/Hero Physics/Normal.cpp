...
namespace CloudberryKingdom
{
	...
	void BobPhsxNormal::InitializeInstanceFields()
	{
		...
		ThrustSoundDelay = 0;
		ThrustSoundCount = 0;
		RndMoveType = Offset = 0;
		RndThrustType = 0;
		BobFallDelay = 0;
		XFriction = BobXDunkFriction = 0;
		BobJumpLength = BobJumpLengthDucking = 0;
		BobInitialJumpSpeed = BobInitialJumpSpeedDucking = BobJumpAccel2 = 0;
		BobJumpLength2 = BobJumpLengthDucking2 = 0;
		BobInitialJumpSpeed2 = BobInitialJumpSpeedDucking2 = BobJumpAccel = 0;
		BobEdgeJump = 0; // 1 if computer waits until edge before jumping = and never walks off = 0 otherwise
		BobEdgeJumpLength = 0; // Duration of BobEdgeJump
		JetPackAccel = 0;
		Thrusting = ReadyToThrust = false;
		StartedJump = false;
		_JumpCount = 0;
		FallingCount = 0;
		ReadyToJump = false;
		ApexY = 0;
		CountSinceApex = 0;
		AutoMoveLength = AutoMoveType = AutoStrafeLength = AutoSetToJumpLength = AutoSetToJumpType = 0;
		AutoDirLength = AutoDir = AutoDirLength_SetTo = 0;
		AutoFallOrJumpLength = AutoFallOrJump = 0;
		NumJumps = 0;
		CurJump = 0;
		JumpDelay = 0;
		JumpDelayCount = 0;
		...
		AutoAllowComputerToJumpOnLand = false;
		NoStickPeriod = 0;
		JumpCountdown = TurnCountdown = Dir = 0;
		Up = false;
		ForcedJumpDamping = 0;
		MinHeightAttained = MinGroundHeightAttained = 0;
