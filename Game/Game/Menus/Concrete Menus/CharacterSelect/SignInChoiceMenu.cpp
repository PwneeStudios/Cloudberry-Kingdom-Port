...
namespace CloudberryKingdom
{
	...
	void SignInMenu::MakeSignInChoiceMenu()
	{
		...
		item = MakeMagic( MenuItem, ( boost::make_shared<EzText>( Localization::Words_SignIn, font ) ) );
		...
		const std::wstring tempVector[] = { Localization::WordString( Localization::Words_Yes ), Localization::WordString( Localization::Words_No ) };
