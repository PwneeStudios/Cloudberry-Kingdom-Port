...
namespace CloudberryKingdom
{
	...
	struct Localization
	{
		...
		enum Words
		{
			...
			Words_POWERUP_NOTE
			, Words_Required, Words_AwardTitle_Campaign1, Words_AwardText_Campaign1, Words_AwardTitle_ArcadeHighScore, Words_AwardText_ArcadeHighScore, Words_AwardTitle_Bungee, Words_AwardText_Bungee, Words_AwardTitle_ArcadeHighScore2, Words_AwardText_ArcadeHighScore2, Words_AwardTitle_Die, Words_AwardText_Die, Words_AwardTitle_Campaign3, Words_AwardText_Campaign3, Words_AwardTitle_Invisible, Words_AwardText_Invisible, Words_AwardTitle_Hats, Words_AwardText_Hats, Words_AwardTitle_Campaign2, Words_AwardText_Campaign2, Words_AwardTitle_UnlockAllArcade, Words_AwardText_UnlockAllArcade, Words_AwardTitle_NoDeath, Words_AwardText_NoDeath, Words_AwardTitle_Save, Words_AwardText_Save, Words_AwardTitle_Obstacles, Words_AwardText_Obstacles, Words_AwardTitle_Buy, Words_AwardText_Buy, Words_AwardTitle_Campaign4, Words_AwardText_Campaign4, Words_AwardTitle_BuyHat, Words_AwardText_BuyHat, Words_AwardTitle_HeroRush2Level, Words_AwardText_HeroRush2Level, Words_AwardTitle_Replay, Words_AwardText_Replay, Words_AwardTitle_Campaign5, Words_AwardText_Campaign5,
		};
