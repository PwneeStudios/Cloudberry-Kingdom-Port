...
namespace CloudberryKingdom
{
	...
	struct Localization
	{
		...
		enum Words
		{
			...
			Words_AwardText_Buy, Words_AwardTitle_Campaign4, Words_AwardText_Campaign4, Words_AwardTitle_BuyHat, Words_AwardText_BuyHat, Words_AwardTitle_HeroRush2Level, Words_AwardText_HeroRush2Level, Words_AwardTitle_Replay, Words_AwardText_Replay, Words_AwardTitle_Campaign5, Words_AwardText_Campaign5,
		};
