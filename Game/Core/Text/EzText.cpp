...
std::unordered_map<Keys, std::wstring> ButtonString::KeyToString = 0;
	...
	void ButtonString::Init()
	{
		...
		KeyToString.insert( make_pair( Keys::None, _T( "None" ) ) );

		KeyToString.insert( make_pair( Keys::A, _T( "A" ) ) );
		KeyToString.insert( make_pair( Keys::B, _T( "B" ) ) );
		KeyToString.insert( make_pair( Keys::C, _T( "C" ) ) );
		KeyToString.insert( make_pair( Keys::D, _T( "D" ) ) );
		KeyToString.insert( make_pair( Keys::E, _T( "E" ) ) );
		KeyToString.insert( make_pair( Keys::F, _T( "F" ) ) );
		KeyToString.insert( make_pair( Keys::G, _T( "G" ) ) );
		KeyToString.insert( make_pair( Keys::H, _T( "H" ) ) );
		KeyToString.insert( make_pair( Keys::I, _T( "I" ) ) );
		KeyToString.insert( make_pair( Keys::J, _T( "J" ) ) );
		KeyToString.insert( make_pair( Keys::K, _T( "K" ) ) );
		KeyToString.insert( make_pair( Keys::L, _T( "L" ) ) );
		KeyToString.insert( make_pair( Keys::M, _T( "M" ) ) );
		KeyToString.insert( make_pair( Keys::N, _T( "N" ) ) );
		KeyToString.insert( make_pair( Keys::O, _T( "O" ) ) );
		KeyToString.insert( make_pair( Keys::P, _T( "P" ) ) );
		KeyToString.insert( make_pair( Keys::Q, _T( "Q" ) ) );
		KeyToString.insert( make_pair( Keys::R, _T( "R" ) ) );
		KeyToString.insert( make_pair( Keys::S, _T( "S" ) ) );
		KeyToString.insert( make_pair( Keys::T, _T( "T" ) ) );
		KeyToString.insert( make_pair( Keys::U, _T( "U" ) ) );
		KeyToString.insert( make_pair( Keys::V, _T( "V" ) ) );
		KeyToString.insert( make_pair( Keys::W, _T( "W" ) ) );
		KeyToString.insert( make_pair( Keys::X, _T( "X" ) ) );
		KeyToString.insert( make_pair( Keys::Y, _T( "Y" ) ) );
		KeyToString.insert( make_pair( Keys::Z, _T( "Z" ) ) );

		KeyToString.insert( make_pair( Keys::Enter, _T( "Enter" ) ) );
		KeyToString.insert( make_pair( Keys::Space, _T( "Space" ) ) );
		KeyToString.insert( make_pair( Keys::Back, _T( "Backspace" ) ) );
		KeyToString.insert( make_pair( Keys::Escape, _T( "Esc" ) ) );
