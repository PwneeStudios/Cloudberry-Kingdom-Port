...
Color Color::Green( unsigned char( 0 ), unsigned char( 255 ), unsigned char( 0 ), unsigned char( 255 ) );
...
Color Color::LightSlateGray( unsigned char( 119 ), unsigned char( 136 ), unsigned char( 153 ), unsigned char( 255 ) );
Color Color::LimeGreen( unsigned char( 50 ), unsigned char( 205 ), unsigned char( 0 ), unsigned char( 255 ) );
Color Color::Lime( unsigned char( 0 ), unsigned char( 255 ), unsigned char( 0 ), unsigned char( 255 ) );
