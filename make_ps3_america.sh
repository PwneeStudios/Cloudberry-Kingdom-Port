# Copy SFO
echo Renaming PARAM_SCEA.SFO to PARAM.SFO
cp -f Cloudberry\ PS3/PARAM_SCEA.SFO "PS3_GAME/PARAM.SFO"
...
cp -f Cloudberry\ PS3/PS3_Release/Cloudberry_Kingdom.self PS3_Final_Package/America/
...
# Make the package
echo Making package
make_package_npdrm Cloudberry\ PS3/pkg_config_scea.txt PS3_GAME

# Copy package to PS3_Final_Package
echo Copying package
cp -f UP0001-NPUB31177_00-CLOUDBERRYKIFULL.pkg PS3_Final_Package/America/
